...
const Navbar = () => {
  return (
    <div className="w-full flex justify-center bg-[#000814]">
      <nav
      ...
      >
        ...
        <Link href="/skills" className="hover:text-[#f7941d] transition-colors">
          Skills
        </Link>
        <Link href="/projects" className="hover:text-[#f7941d] transition-colors">
          Projects
        </Link>
